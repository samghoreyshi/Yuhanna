...
export default function Navbar() {
    ...
    isMobileMenuOpen && (
      <div className="fixed inset-x-0 bottom-0 h-[75vh] overflow-y-auto bg-white/95 backdrop-blur-lg rounded-t-3xl shadow-2xl border-t border-blue-100/50 z-[9999]">
        <div className="px-4 pb-16 pt-5 space-y-1 relative">
          ...
          <div className="pt-4 border-t border-blue-100/30 mt-4 space-y-2">
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-3 w-full p-3 rounded-xl hover:bg-blue-50/30 transition-colors text-red-500"
                >
              ...
              <Link
                href="/auth/login"
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex items-center justify-center w-full gap-3 px-5 py-2 rounded-xl whitespace-nowrap bg-gradient-to-r from-blue-600 to-blue-500 text-white hover:from-blue-700 hover:to-blue-600 transition-colors duration-300 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30"
              >
  ...
  return (
    <>
      ...
      >
        {/*
          Use a full-width container so that the logo, auth links, and hamburger remain within the viewport.
        */}
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
                ...
                <div className="relative" ref={eventsDropdownRef}>
                  ...
                  {isEventsOpen && (
                    <div className="absolute right-0 mt-3 z-50 p-4 bg-white border rounded-lg shadow-lg transition-all duration-200">
                      {/* Dynamic grid layout for event items */}
            ...
            {/* Right Side: Auth/User Menu (visible on sm and up) and Hamburger (always visible on mobile) */}
            <div className="flex items-center gap-4">
              <div className="hidden sm:flex items-center">
                {user ? (
                  ...
                  <Link
                    href="/auth/login"
                    className="flex items-center gap-2 px-5 py-2 rounded-xl whitespace-nowrap"
                  >
                    <HiOutlineUser className="w-5 h-5" />
                    <span>ثبت نام | ورود</span>
                  </Link>
              ...
              <button
                ...
                className="inline-flex sm:hidden items-center justify-center p-2 rounded-xl text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors duration-300"
              >
